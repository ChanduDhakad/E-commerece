...
public class ProductServiceImpl implements ProductService {
	...
	@Override
	public List<Products> viewAllProductById(Integer sellerId, String key)
		...
		if (splist.size() == 0)
			throw new ProductException("No Product Added By this Seller...");

		return splist;
	}

	@Override
	public Products viewProductById(Integer sProdcutId, String key, Integer sellerId)
			throws ProductException, SellerException, LoginException {
		...
		if (opt.isEmpty())
			throw new ProductException("No Product Found With Id:- " + sProdcutId);
		return opt.get();
	}

	@Override
	public List<Products> viewByCategory(String Category, String key, Integer sellerId)
			throws ProductException, SellerException, LoginException {
	...
	public String removeSellerProduct(Integer sproductId, String key, Integer sellerId)
		...
		if (proOpt.isEmpty())
			throw new ProductException("No Product Found With Id:- " + sproductId);
	...
	public Products updateProduct(Integer sellerId, String key, Products sProduct)
		...
		if (proOpt.isEmpty())
			throw new ProductException("No Product Found With Id:- " + sProduct.getSeller_ProductId());
	...
	public Seller CheckLogin(Integer sellerId, String key) throws SellerException, LoginException {
		...
		if (opt.isEmpty())
			throw new SellerException("Invalid SellerId");
